    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/40 text-sm leading-relaxed max-w-xs">
            Create your account and get access to exclusive drops, order tracking, and a personalized experience.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 bg-white flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-black uppercase tracking-tight text-gray-900">Create Account</h1>
            <p className="text-gray-400 text-sm mt-1">Already a member?{" "}
              <Link to="/login" className="text-black font-semibold hover:text-red-500 transition underline underline-offset-4">Sign In</Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="text-[11px] uppercase tracking-widest text-gray-400 font-semibold block mb-2">Full Name</label>
